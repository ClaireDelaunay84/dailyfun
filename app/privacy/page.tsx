        ...
        <main style={{minHeight: "100vh", background: "#fdf8f3"}}>
            ...
            <div style={{
                ...
                <section style={{marginBottom: "32px"}}>
                    ...
                    <p>
                        Dailyfun (<strong>dailyfun.fr</strong>) est un site de contenu culturel quotidien. Il ne
                        nécessite
                        aucune inscription, aucun compte utilisateur et ne collecte aucune donnée personnelle
                        identifiante.
                    </p>
                </section>
                ...
                <section style={{marginBottom: "32px"}}>
                    ...
                    <p>
                        Dailyfun collecte uniquement la <strong>géolocalisation de votre appareil</strong>, et
                        uniquement
                ...
                <section style={{marginBottom: "32px"}}>
                    ...
                    <p>
                        Dailyfun n'utilise pas de cookies publicitaires ni de traceurs. Des cookies techniques
                        strictement
                ...
                <section style={{marginBottom: "32px"}}>
                    ...
                    <ul style={{marginTop: "10px", paddingLeft: "20px"}}>
                        <li style={{marginBottom: "6px"}}>
                            <strong>OpenWeatherMap</strong> — pour récupérer les données météo à partir de votre
                            localisation.
                            Leur politique de confidentialité est disponible sur{" "}
                            <a href="https://openweathermap.org/privacy-policy" target="_blank"
                               style={{color: "#9E7F5C"}}>
                                openweathermap.org
                            </a>
                        </li>
                        <li style={{marginBottom: "6px"}}>
                            <strong>Wikimedia / Wikipédia</strong> — pour récupérer des données encyclopédiques
                            publiques
                ...
                <section style={{marginBottom: "32px"}}>
                    ...
                    <p>
                        ...
                        d'accès, de rectification et de suppression de vos données. Dans la mesure où Dailyfun ne
                        collecte
                ...
                <section style={{marginBottom: "32px"}}>
                    ...
                    <p>
                        Dailyfun ne stockant aucune donnée personnelle, aucune procédure de suppression n'est
                        nécessaire.
