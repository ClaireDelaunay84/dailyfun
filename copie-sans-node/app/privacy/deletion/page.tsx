        ...
        <main style={{
            ...
            <section style={{ marginBottom: "32px" }}>
                ...
                <ul style={{ marginTop: "10px", paddingLeft: "20px" }}>
                    <li style={{ marginBottom: "6px" }}><strong>Chrome</strong> — Paramètres → Confidentialité → Paramètres des sites → Localisation</li>
                    <li style={{ marginBottom: "6px" }}><strong>Safari</strong> — Préférences → Sites web → Localisation</li>
