...
export const journeesA: Record<string, JourneeInternationale[]> = {
    ...
    "03-26": [
        ...
        },
        {
            ...
            description: "Donc si vous l'avez remise à aujourd'hui, proftez-en, c'est encore libre...!"
        },
    ],
    "03-27": [
        {
    ...
    "04-19": [
        ...
        { nom: "Journée nationale de la limonade", description: "La première 'eau gazeuse' fut inventée en 1767 par Joseph Priestley — le même scientifique qui découvrit l'oxygène. Un homme aux bulles et aux gaz, dans tous les sens du terme !" },
    ],
    "04-20": [
        { nom: "Journée nationale du musée", description: "Il y a 55 000 musées dans le monde. Le Louvre est le plus visité avec 9 millions de visiteurs par an. La Joconde mesure seulement 77 x 53 cm — beaucoup de visiteurs sont déçus par sa petite taille. La réputation précède la réalité !" },
        { nom: "Journée mondiale sans téléphone portable", description: "Les humains regardent leur téléphone en moyenne 150 fois par jour. Une journée sans portable par semaine améliore la qualité du sommeil, la concentration et les relations sociales. L'expérience est difficile mais transformatrice !" },
    ],
    "04-21": [
        { nom: "Journée mondiale de la créativité", description: "Albert Einstein disait que l'imagination est plus importante que la connaissance. Les enfants de 5 ans ont un taux de créativité de 98% ; à 25 ans, il est tombé à 2%. L'école ne fait pas que développer — elle peut aussi contraindre !" },
        { nom: "Journée nationale du hot-dog", description: "Le hot-dog fut introduit aux États-Unis par des immigrants allemands dans les années 1860. Il se vend 7 milliards de hot-dogs par an aux USA. Le débat infini : moutarde ou ketchup ? (Moutarde, évidemment) !" },
    ],
    "04-22": [
        { nom: "Journée mondiale de la Terre", description: "Créée en 1970, Earth Day mobilise 1 milliard de personnes dans 193 pays. C'est la plus grande fête environnementale de la planète. Depuis 1970, les énergies renouvelables ont été multipliées par 10 en 10 ans — l'espoir est là !" },
        { nom: "Journée nationale du vers de terre", description: "Un ver de terre retourne jusqu'à 300 tonnes de sol par hectare par an — les ingénieurs silencieux de notre planète. Une cuillère à café de sol fertile contient plus de micro-organismes que d'humains sur Terre !" },
    ],
    "04-23": [
        { nom: "Journée mondiale du livre et du droit d'auteur", description: "Le 23 avril est la date de mort de Shakespeare ET de Cervantes (même jour, 1616 !). L'UNESCO en a fait la journée du livre. Les Espagnols offrent des livres et des roses ce jour-là — une belle tradition culturelle !" },
        { nom: "Journée mondiale de la langue espagnole", description: "L'espagnol est parlé par 580 millions de personnes dont 485 millions de locuteurs natifs. C'est la 2e langue la plus étudiée au monde. Cervantes, Neruda, García Márquez — l'espagnol a produit des géants de la littérature !" },
    ],
    "04-24": [
        { nom: "Journée nationale du jus de citron", description: "Les Romains utilisaient le citron pour repousser les mites et parfumer les vêtements avant de comprendre qu'on pouvait le manger. Le citron contient plus de sucre que la fraise — mais l'acide citrique masque complètement le goût sucré !" },
        { nom: "Journée mondiale des vétérinaires", description: "Il y a 1 million de vétérinaires dans le monde. Un vétérinaire doit connaître l'anatomie de centaines d'espèces. Les vétérinaires des zoos soignent parfois des animaux qu'ils ne peuvent pas toucher — la médecine à distance !" },
    ],
    "04-25": [
        { nom: "Journée mondiale du paludisme", description: "Le paludisme tue un enfant toutes les 2 minutes en Afrique. Pourtant, une moustiquaire imprégnée à 2€ peut réduire de 50% le risque de transmission. Une solution aussi simple que l'humanité peine encore à universaliser !" },
        { nom: "Journée nationale des manchots", description: "Les manchots sont monogames et retrouvent leur partenaire parmi des milliers en reconnaissant son chant. Un manchot peut plonger à 500m de profondeur et retenir son souffle 20 minutes. Des athlètes sous-marins impressionnants !" },
    ],
    "04-26": [
        { nom: "Journée mondiale de la propriété intellectuelle", description: "Les brevets existent depuis 1474 à Venise. En 2023, 3,4 millions de brevets ont été déposés dans le monde. La propriété intellectuelle représente 80% de la valeur des entreprises du S&P 500 — nos idées valent plus que nos usines !" },
        { nom: "Journée nationale du bretzel au fromage", description: "Les bretzels au fromage sont nés en Allemagne dans les années 1950. Le fromage fondu crée des liens moléculaires complexes avec le gluten du bretzel — un mariage chimique aussi délicieux que savant !" },
    ],
    "04-27": [
