...
export const journeesA: Record<string, JourneeInternationale[]> = {
    ...
    "04-30": [
        { nom: "Journée internationale du jazz",
            description: "🎺 La Journée Internationale du Jazz célèbre cette musique née dans les quartiers de La Nouvelle-Orléans qui a conquis le monde entier — un art de l'improvisation et du dialogue qui transcende les frontières et les cultures" },
        { nom: "Journée nationale des véhicules d'époque",
            description: "🔧 La Journée Nationale des Véhicules d'Époque célèbre ces bolides et carrosses d'antan méticuleusement restaurés par des passionnés — de véritables œuvres d'art mécaniques qui font rugir les moteurs et vibrer la nostalgie ! 🏁" },
        { nom: "Journée Mondiale de prière pour les vocations",
            description: " 🕊️ Chaque quatrième dimanche de Pâques, la Journée Mondiale de Prière pour les Vocations invite les fidèles du monde entier à prier pour ceux qui ressentent l'appel à la prêtrise, à la vie religieuse ou au service de Dieu !" },
        { nom: "Journée Mondiale des mobilités et de l'accessibilité",
            description: "🚶 La Journée Mondiale des Mobilités et de l'Accessibilité rappelle que se déplacer librement est un droit fondamental — et qu'il reste encore tant à faire pour que l'espace public soit réellement accessible à toutes et tous, quelles que soient leurs capacités ! " },
        { nom: "Journée nationale des véhicules d'époque",
            description: "🧒 Chaque 30 avril, la Journée de la Non Violence Éducative rappelle que les enfants s'épanouissent mieux dans le respect et la bienveillance — et que punitions physiques et humiliations n'ont aucune place dans l'éducation d'aujourd'hui " },
    ],
    "05-01": [
        { nom: "Journée Mondiale du Travail",
            description: "✊ Chaque 1er mai, la Journée Mondiale du Travail rend hommage aux luttes ouvrières qui ont arraché nos droits fondamentaux — congés payés, journée de 8 heures, protection sociale — des acquis précieux qu'il faut continuer de défendre" },
     ],
    "05-02": [
        { nom: "Journée mondiale de l'asthme",
            description: "💨 Chaque premier mardi de mai, la Journée Mondiale de l'Asthme sensibilise à cette maladie respiratoire chronique qui touche plus de 300 millions de personnes dans le monde — encore trop souvent mal diagnostiquée et mal prise en charge " },
        { nom: "Journée mondiale du thon",
            description: "🌊 Chaque 2 mai, la Journée Mondiale du Thon alerte sur la surpêche qui menace ces géants des océans — une espèce vitale pour l'équilibre des écosystèmes marins qui disparaît bien plus vite qu'elle ne se reproduit ! 🎣" },
        { nom: "Journée des bébés",
            description: "👶 La Journée des Bébés célèbre ces petits êtres qui débarquent dans le monde avec leurs grands yeux émerveillés — un rappel tout doux que chaque naissance est un miracle et que les premiers mois de vie sont fondateurs pour toute une existence" },
    ],
    "05-03": [
        { nom: "Journée mondiale de la liberté de la presse",
            description: "🖊️ Chaque 3 mai, la Journée Mondiale de la Liberté de la Presse rappelle que l'information libre et indépendante est le pilier de toute démocratie — et que des dizaines de journalistes risquent encore leur vie chaque jour pour nous dire la vérité " },
        { nom: "Journée du soleil",
            description: "🌞 Chaque 3 mai, la Journée du Soleil célèbre notre étoile nourricière et sensibilise aux énergies solaires renouvelables — un rappel que le soleil nous offre chaque jour une énergie propre et inépuisable, encore trop peu exploitée" },
    ],
    "05-04": [
        { nom: "Journée internationale des pompiers",
            description: "🔥 Chaque 4 mai, la Journée Internationale des Pompiers rend hommage à ces femmes et hommes qui risquent leur vie pour sauver celle des autres — des héros du quotidien toujours prêts à intervenir face aux flammes, aux accidents et aux catastrophes" },
        { nom: "Journée Internationale des Mères endeuillées",
            description: "🌹 La Journée Internationale des Mères Endeuillées offre un espace de reconnaissance et de recueillement à toutes ces femmes qui portent l'indicible douleur de la perte d'un enfant — un deuil silencieux et souvent incompris qui mérite d'être enfin reconnu ! 💔" },
        { nom: "Star Wars Day — May the 4th be with you !",
            description: "🚀 Chaque 4 mai, les fans de la galaxie lointaine, très lointaine célèbrent Star Wars Day avec un jeu de mots devenu culte : \"May the 4th be with you\" — une journée pour rallumer son sabre laser et replonger dans l'une des sagas les plus mythiques de l'histoire du cinéma " },
    ],
    "05-05": [
        { nom: "Journée mondiale de la Sage-Femme",
            description: "👶 Chaque 5 mai, la Journée Mondiale de la Sage-Femme rend hommage à ces professionnelles de santé essentielles qui accompagnent la vie dès ses premiers instants — des expertes du soin et de l'écoute qui œuvrent chaque jour pour la santé des femmes et des nouveau-nés ! 🌸" },
        { nom: "Journée mondiale de l'hygiène des mains",
            description: "🧼 Chaque 5 mai, la Journée Mondiale de l'Hygiène des Mains rappelle que ce geste simple de 30 secondes reste l'un des actes les plus efficaces pour prévenir la propagation des maladies infectieuses — un réflexe qui sauve des millions de vies chaque année ! 💧" },
        { nom: "Journée du patrimoine mondial Africain",
            description: "🏺 Chaque 5 mai, la Journée du Patrimoine Mondial Africain célèbre la richesse extraordinaire des cultures, traditions et sites historiques du continent africain — un héritage millénaire d'une diversité inouïe qui appartient à toute l'humanité" },
        { nom: "Journée mondiale de la langue portugaise",
            description: "🗣️ Chaque 5 mai, la Journée Mondiale de la Langue Portugaise célèbre cette langue aux sonorités envoûtantes parlée par plus de 250 millions de personnes sur quatre continents — du Brésil au Portugal en passant par l'Afrique, le portugais est un pont entre les cultures" },
    ],
    "05-06": [
        { nom: "Journée internationale sans régime",
            description: "🥗 Chaque 6 mai, la Journée Internationale sans Régime invite à célébrer son corps tel qu'il est et à questionner la culture de la minceur à tout prix — parce que la santé ne se résume pas à un chiffre sur une balance" },
        { nom: "Journée internationale des drônes",
            description: "🎮 Chaque 6 mai, la Journée Internationale des Drones célèbre ces engins volants qui révolutionnent la photographie, la livraison, l'agriculture et bien d'autres secteurs — une technologie fascinante qui redessine notre rapport au ciel et à l'espace" },
        { nom: "Journée mondiale du jardinage nu",
            description: "🌸 Chaque premier samedi de mai, la Journée Mondiale du Jardinage Nu invite les plus téméraires à entretenir leur jardin dans le plus simple appareil — une célébration décalée et joyeuse du corps naturel et du retour à la terre, à condition de se méfier des orties " },
        { nom: "Journée mondiale du coloriage",
            description: "🎨 La Journée Mondiale du Coloriage célèbre ce plaisir universel qui nous reconnecte à notre âme d'enfant — parce que colorier entre les lignes (ou pas !) reste l'une des meilleures thérapies anti-stress qui soit ! 🌈" },
        { nom: "Journée mondiale du scrapbooking",
            description: "📸 Chaque premier samedi de mai, la Journée Mondiale du Scrapbooking célèbre cet art créatif qui transforme photos, souvenirs et petits riens du quotidien en albums uniques et précieux — une façon poétique de capturer le temps avant qu'il ne s'efface ! 🎀" },
        { nom: "Journée mondiale du mot de passe",
            description: "💻 Chaque premier jeudi de mai, la Journée Mondiale du Mot de Passe rappelle que \"123456\" n'est toujours pas un bon mot de passe — une journée pour enfin mettre à jour ses identifiants et adopter de bonnes pratiques de sécurité numérique" },
     ],
    "05-07": [
